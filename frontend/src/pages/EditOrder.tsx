...
import { Trash2, Plus, X, Loader2, AlertCircle, DollarSign } from 'lucide-react';
...
const EditOrder = () => {
  ...
  const handleAddItem = (menu_item_id: number) => {
    addItemMutation.mutate(menu_item_id);
  };
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      <div className="w-1/3 bg-white p-6 overflow-y-auto border-l border-gray-200">
        ...
        <div className="mb-6">
          <label className="flex items-center space-x-2">
            ...
            />
            <span className="text-gray-700">All You Can Eat Order</span>
          </label>
        </div>
